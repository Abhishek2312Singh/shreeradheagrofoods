  ...
  const initializeSampleActivities = () => {
    const sampleActivities = [
      ...
      },
      {
        ...
        description: "Shree Radhe Agro Foods has been recognized with the Green Business Award for our sustainable farming practices and eco-friendly processing methods. We're committed to environmental responsibility.",
        date: "2024-01-30",
        category: "achievements",
        image: "",
